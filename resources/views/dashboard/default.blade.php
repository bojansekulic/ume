...
{{--<div class="row">--}}
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-3">
            <a href="{{ route('campaign_index') }}" class="panel-link">
                <div class="panel panel-default dashboard-panel">
                    <div class="panel-body">
                        <div class="icon">
                            <i class="fa fa-send-o"></i>
                        </div>
                        <p class="lead">@lang('Create Campaign')</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-3">
            <a href="{{ route('campaign_launch') }}" class="panel-link">
                <div class="panel panel-default dashboard-panel">
                    <div class="panel-body">
                        <div class="icon">
        ...
        <div class="col-md-3">
            <a href="{{ route('campaign_stats') }}" class="panel-link">
                <div class="panel panel-default dashboard-panel">
                    <div class="panel-body">
                        <div class="icon">
                            <i class="fa fa-line-chart"></i>
                        </div>
                        <p class="lead">@lang('Campaign Stats')</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-3">
            <a href="{{ route('testemail') }}" class="panel-link">
                <div class="panel panel-default dashboard-panel">
                    <div class="panel-body">
                        <div class="icon">
                            <i class="fa fa-send"></i>
                        </div>
                        <p class="lead">@lang('Test Email Campaign')</p>
                    </div>
                </div>
            </a>
        </div>
