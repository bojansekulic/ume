...
<head>
    ...
    <title>@yield('page-title') | UpecajME </title>

    <link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">

    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ url('assets/img/icons/ikona144x144.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ url('assets/img/icons/ikona152x152.png') }}" />
    <link rel="icon" type="image/png" href="{{ url('assets/img/icons/ikona32x32.png') }}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{ url('assets/img/icons/ikona16x16.png') }}" sizes="16x16" />
    <meta name="application-name" content="{{ "UpecajME" }}"/>
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ route('dashboard') }}" style="padding: 7px 0 0 0;">
                <img src="{{ url('assets/img/logo-upecaj-me.png') }}" height="40" alt="{{ settings('app_name') }}">
            </a>
        </div>
